...
@Index("idx_ticket_event_id", ["ticketEventId"], {})
@Index("idx_supplier_id", ["supplierId"], {})
@Index("idx_tickets_event_category", ["ticketEventId", "ticketCategoryId"], {})
@Index(
  "idx_tickets_supplier",
  ["supplierId", "activated", "deleted", "maxTickets"],
  {}
)
@Index("idx_parent_ticket", ["parentTicketId"], {})
@Entity("tickets", { schema: "ftn_db_main" })
export class Tickets {
  @PrimaryGeneratedColumn({ type: "int", name: "ticket_id", unsigned: true })
  ticketId: number;

  @Column("int", { name: "parent_ticket_id", nullable: true })
  ...
  @Column("tinyint", { name: "lower_price_approved", nullable: true })
  lowerPriceApproved: number | null;
}
